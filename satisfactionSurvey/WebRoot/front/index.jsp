...
<div class="login_div" >
	...
	<form action="/satisfactionSurvey/user/login.do" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="account" id="name" value="" placeholder="&nbsp;&nbsp;用户名/手机号"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
